<div class="modal fade" id="modalNewMidtrans" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">New Midtrans Config</h5>
            </div>
            <form id="formSubmit">
                @csrf
